...
export const sortOptionByPosition = (options: ISelectOption[]): ISelectOption[] => {
...
export const findAndRemoveOption = (options: ISelectOption[], value: string): ISelectOption[] => {
